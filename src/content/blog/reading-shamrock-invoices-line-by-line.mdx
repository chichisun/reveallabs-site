---
title: "What I Learned from 20 Years of My Parents Reading Vendor Invoices"
slug: "reading-shamrock-invoices-line-by-line"
publishDate: "2026-05-02"
metaDescription: "My parents have been reading Shamrock invoices line by line for two decades. Here's the seven-step audit they taught me, the patterns they look for, and the free Google Sheet that puts the habit on a timer."
...
My parents have been reading vendor invoices line by line at Tuk Tuk for twenty years.
...
I didn't get it for a long time. I assumed they were being thorough in the way restaurant operators of a certain era are about everything — the same way Mom counts the napkin stock or Dad insists on closing out the tip pool by hand. I figured the math was small. The kitchen ran. We were a family restaurant in Denver, not a chain. What was there really to catch?

Then I started running their books with them. The first month, I watched them flag a fuel surcharge that had drifted from 4% to 6.5% with no notice. The second month, a substitute brand of coconut milk got billed at the price of the spec'd brand instead of the substitute's price. The third month, a credit they'd been promised six weeks earlier finally hit the invoice — only because they'd kept a one-line tracker and emailed the rep when it didn't show.
...
The audit my parents taught me takes 30 minutes a week if you have the right sheet open. The sheet is at the bottom of this post. Free, no email gate.

## The seven things they look at on every Shamrock invoice

For years I'd been told to "watch your food costs." That advice is roughly as useful as "watch your weight" — true, vague, hard to act on. The version my parents do is to break the invoice into seven categories where vendors quietly add or change charges, and to look at one category per pass instead of trying to read the whole invoice cold.

This is the order they run, and the order they taught me.
...
Mom has fifteen items she orders every single week. Coconut milk. Jasmine rice. Curry paste. Soy sauce. Lime juice. Cooking oil. Basil. Cilantro. Pad thai noodles. Chicken thighs. The proteins and pantry that make Tuk Tuk Tuk Tuk.

These are the items where she should know the unit price by heart. If the unit price moves on any of them, she wants to know that week, not at month-end when she's reconciling food cost.
...
What Dad taught me: someone has to count the truck against the invoice as it comes off. Not later. Not from the kitchen. At the door. Anything missing gets noted on the invoice in pen, signed by the driver, and photographed with a phone before the driver leaves. That's your evidence when you ask for the credit.
...
Mom keeps a one-line log of every credit she's been promised, with the date, dollar amount, and rep's name. Each week, she scans the invoice for those credit numbers. They show up as `CREDIT - INV# XXXX` near the bottom, separate from the main line items. If a promised credit isn't on the invoice within 30 days of being promised, it's an email back to the rep with the original ticket number.

Most operators I've talked to lose 30–50% of credits they're owed simply because nobody's tracking them. My parents have been tracking them since before I could read.
...
Here's the rhythm Mom runs on Sunday mornings before service. It's the same rhythm she's been running since 2006, with the spreadsheet upgraded once or twice.
...
## What twenty years of this taught my parents

Two things, and they took me a while to absorb.
...
**Second, this is a habit, not a project.** The reason vendor-billing audits are weekly and not quarterly is that the patterns shift. The fuel surcharge that was clean in January creeps in February. The substitute that wasn't flagged in March gets flagged in April. A quarterly audit catches half of what a weekly audit does. My parents have run this every Sunday for twenty years. The compounding effect is hard to overstate. They've never lost a credit they were owed because Mom keeps the tracker. They've never been surprised by a price hike because the staples table catches it the same week. The Shamrock rep treats them differently because they always show up with line items, never with vibes.

When I started running their books, I assumed I'd find some clever trick they were missing. I didn't find one. The trick was the habit.

## The free sheet

I built a Google Sheet that runs the seven checks above — modeled on what Mom has been doing in spreadsheets, paper ledgers, and (early on) a green-and-white columnar pad since 2006. Tabs for each category, formulas to highlight week-over-week changes, and a credit tracker. Free, no email gate, copy it to your own Drive and modify it for your distributor. It works for Shamrock, Sysco, US Foods, PFG, Gordon — they all structure invoices similarly enough.
